class Game < ApplicationRecord
    ...
    before_save :generate_string

    def generate_string
        until self.memorable_string_name
            new_str = generate
            self.memorable_string_name = new_str unless Game.find_by(memorable_string_name: new_str)
        end
    end
    ...
    def generate
        ...
        "Kilo", "Lima", "Oscar", "Papa", "Tango", "Victor", "Yankee", "Zulu"]
